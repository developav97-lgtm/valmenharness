...
- Usuario o rol afectado: meseros y cajeros del tenant que abren una orden desde el mapa de mesas. Caso reportado: bipanes, estación del usuario id 138, sucursal 2, 2026-09-17 20:37–20:50 COT.
...
[
  {
    ...
    "status": "closed",
    "severity": "normal",
    "actual": "Cuando la carga de una orden falla en el cliente, el mensaje generico no deja ningun rastro: el registro de errores operativos solo captura respuestas HTTP >=500 y el catch de processOrder descarta la excepcion. En el caso de bipanes no hubo ningun registro pese a ~30 intentos fallidos.",
