 ...
 */
export const V2_ONLY_TICKET_TYPES = ["CHORE", "DOCS"] as const;

export const RISK_LEVELS = ["low", "normal", "high", "critical"] as const;
 ...
 */
export const LEGACY_EVIDENCE_KINDS: Readonly<Record<string, EvidenceKind>> = {
 ...
 */
export function normalizeEvidenceKind(kind: string): EvidenceKind | undefined {
...
export const ID_PREFIXES = {
  ...
  Eventos: "EVENT",
} as const satisfies Record<StructuredSectionName, string>;
