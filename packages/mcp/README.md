...
Las treinta y ocho herramientas. Ninguna es una segunda implementación: las de lectura llaman a
...
| `anexar_ticket_a_feature` | Mete en el grafo un ticket que ya existe, o lo saca              |
