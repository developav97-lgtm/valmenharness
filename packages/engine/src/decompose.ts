...
export const SISTEMA_DESCOMPOSICION = [
  ...
  "   de tres renglones no se lee y esconde el trabajo en vez de anunciarlo.",
  "   El título va en una línea y **sin «: »**: el frontmatter de un ticket se lee sin",
  "   una librería YAML, y dos puntos seguidos de espacio lo convierten en un mapa.",
  "   Un título que no se puede escribir obliga a corregir el grafo a mano.",
